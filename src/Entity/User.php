...
class User implements UserInterface
{
     ...
     *  },
     *  inverseJoinColumns={
     *      @ORM\JoinColumn(name="subscription_on_id", referencedColumnName="id")
     *  }
     * )
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="Post", mappedBy="author", cascade={"persist"}, orphanRemoval=true)
     */
    private $posts;
     ...
     */
    public function setSubscribers($subscribers): PersistentCollection
    {
